...
})({"ljtM8":[function(require,module,exports) {
    ...
    return function(Module) {
        ...
        function __embind_register_class_property(classType, fieldName, getterReturnType, getterSignature, getter, getterContext, setterArgumentType, setterSignature, setter, setterContext) {
            ...
            whenDependentTypesAreResolved([], [
                ...
                if (setter) desc.set = function() {
                    throwUnboundTypeError("Cannot access " + humanName + " due to unbound types", [
                        getterReturnType,
                        setterArgumentType
                    ]);
                };
                else desc.set = function(v) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ljtM8"], null, "parcelRequire3e46")
